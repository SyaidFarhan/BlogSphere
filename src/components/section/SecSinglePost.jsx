...
export default function SecSinglePost() {
  ...
  const [formData, setFormData] = useState({
    ...
    title: "",
    userProfile: "",
    profileImage: "", // Perbaikan: Menambahkan profileImage di formData
  });
    ...
    const fetchAuthorProfile = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          profileImage: authorData.profileImage || "", // Menambahkan profileImage ke formData
        });
      } catch (error) {
    ...
    setIsEditing((prev) => {
      ...
      if (prev) {
        setFormData({
          ...
          profileImage: user.profileImage || "", // Reset profileImage
        });
      }
      return !prev;
    });
      ...
      >
        ...
        {isEditing ? (
          <>
            ...
            <input
              type="text"
              name="profileImage" // Perbaikan: Ganti dengan profileImage
