...
export default function SecBlogHome() {
  ...
  return (
    <div id="blog" className="container">
      <h3 className="pt-5 mb-4">Article For You!</h3>
      <div className="row">
        {articles
          .sort((a, b) => new Date(b.publishDate) - new Date(a.publishDate)).slice(0, 3) // Urutkan artikel berdasarkan tanggal terbaru
          .map((article) => (
